...
import pandas as pd
import pickle
from losses.loss_and_model import loss_model_bel, loss_model_reparam, loss_model_no_train
from problems import double_well_toy_problem, dm_toy_problem, ou_toy_problem, double_well_toy_problem_opening
    ...
    for i in range(len(problems)):
        for j in range(len(loss_models)):
            ...
            final_params, best_params, all_metrics, best_metrics = train_model(
                rng, ts, nn_model, true_control, y_obs, y_init_eval, sde, loss_function, 
