from jax import random, jacfwd, jacrev, jacobian, grad, jit, vmap, value_and_grad
...
def solve_J_equation_2(rng, sde, ts, sample_path, sample_dBts, **kwargs):
    ...
    def step(carry, params):
        ...
        if mode == "last":
            ...
            doob = sigma_dBt * is_first + propagated_doob #dt * doob.T.dot(drift_jac(t, x)) + doob.T.dot(sigma_jac(t, x, dBt))
